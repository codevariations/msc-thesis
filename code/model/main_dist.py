...
from custom_loss import PoincareSQDistLoss
...
def save_checkpoint(state, is_best, filename='checkpoint_sqdist.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_sqdist.pth.tar')
