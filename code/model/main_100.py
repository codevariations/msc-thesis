...
def main():
    ...
    # Data loading code
    traindir = os.path.join(args.data, 'train_100')
...
def save_checkpoint(state, is_best, filename='checkpoint_100.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_100.pth.tar')
