...
\begin{itemize}
  \item essentially our model proposes that semantic taxonomy is the best guide to visual taxonomy -- better than wikipedia 
    ...
    \item maybe different loss function; mse, distortion of xentropy, adding allemb to xentropy
    ...
    \item presenting the entire network in hyperbolic space since CNN learn hierarchical representations in layers, it might be better to have everything in hyperbolic space and then train the entire model on Riemannian optimization.
\end{itemize}
