...
All of the ImageNet image class labels fall within the WordNet lexical database and thus WordNet was the obvious choise for constructing the embedding space. As a whole, WordNet contains 117,000 synsets (synonym sets) grouped into 


Figure \ref{fig:dhsem} depicts the deep-HSEM architecture.
