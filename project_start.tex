...
Above works illustrate the implicit connction between text and visual data processing in humans. The two were shown to be explicitly linked by Joliceur \textit{et al.}
