...
In Euclidean space, this forms a hyperboloid object with two sheets as seen in Figure \ref{fig:lorenz}

\begin{figure}
  \centering
	\includegraphics[width=0.6\textwidth]{lorenz}
	\caption{Hyperboloid model in $\mathbb{R}^3$ and its projection on to the Poincare disk. Image used under Creative Commons license from Wikimedia Commons.}
	\label{fig:lorenz}
\end{figure}
