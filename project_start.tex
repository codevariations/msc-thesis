...
\textbf{PAPERS ON PSYCHOLOGY WITH DL} \\ 

So far below is the only that explicitly takes psychology/DL approach to object categorization. This is still related to many other papers covered here and thus bit strange that it doesnt really cite many of the other DL with linguistic papers that I have covered in the 'zero-shot learning section'.
